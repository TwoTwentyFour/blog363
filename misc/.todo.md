...
17. add try catch block to add_page.php
18. add unable to add page message to add_page.php
20. change new exception to simple echo if query fails in edit_page.php
21. change all files in views dir from .html exts to .view.php exts
